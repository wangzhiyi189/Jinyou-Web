...
const gridOptions: VxeTableGridOptions<RowType> = {
  ...
  columns: [
    { field: 'scheduleId', title: '序号', width: 100 },
    ...
    { field: 'departTime', title: '发车时间',slots: { default: 'departTime' },width: 150 },
    { field: 'arriveTime', title: '到达时间',slots: { default: 'arriveTime' },width: 150 },
